      ...
      <div className="relative z-10 max-w-4xl">
        ...
        >
          ...
          <span className="text-[#ccff00] text-xs font-semibold tracking-widest uppercase">
            Финансовый словарь · 20 терминов
          </span>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-white/50 text-sm sm:text-base max-w-xl leading-relaxed"
        >
          Разгадай термины фондового рынка. Угадывай слова — и открывай карточки с теорией.
          Идеальный способ прокачать знания в инвестициях, трейдинге и экономике.
        </motion.p>
